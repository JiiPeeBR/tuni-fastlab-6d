...
FUNCTION_BLOCK MC_BR_AsmWriteShIDTable_Acp6D (*Write entire shuttle ID table.*)
	VAR_INPUT
		Assembly : REFERENCE TO Mc6DAssemblyType; (*The assembly reference establishes the connection between the function block and the assembly.*)(*#PAR#;*)
		Execute : BOOL; (*Execution of the function block begins on a rising edge of this input.*)(*#PAR#;*)
		ShIDTable : McAcp6DWriteShIDTableType; (*Shuttle ID table*)(*#PAR#;*)
	END_VAR
	VAR_OUTPUT
		Done : BOOL; (*Execution successful. Function block is finished*)(*#PAR#;*)
		Busy : BOOL; (*Function block is active and must continue to be called.*)(*#PAR#;*)
...
FUNCTION_BLOCK MC_BR_AsmConfigHandler_Acp6D (*Handle the assembly configration.*)
    VAR_INPUT
		Assembly : REFERENCE TO Mc6DAssemblyType; (*The assembly reference establishes the connection between the function block and the assembly.*) (* *) (*#PAR#*)
		Enable : BOOL; (*Enable command execution.*) (* *) (*#PAR#*)
		ErrorReset : BOOL; (*Reset error on rising edge*) (* *) (*#PAR#*)
		LoadToParam : BOOL; (*Execute load from configuration to parameters on a rising edge of this input.*) (* *) (*#CMD#*)
		SaveFromParam : BOOL; (*Execute save from parameters to configuration on a rising edge of this input.*) (* *) (*#CMD#*)
	END_VAR
	VAR_OUTPUT
		Active : BOOL; (*Function block is active and ready to process commands.*) (* *) (*#PAR#*)
		Error : BOOL; (*Execution error*) (* *) (*#PAR#*)
		ErrorID : DINT; (*Error number*) (* *) (*#PAR#*)
		CommandBusy : BOOL; (*Command executing*) (* *) (*#CMD#*)
		CommandDone : BOOL; (*Command execution successful, command execution finished*) (* *) (*#CMD#*)
	END_VAR
	VAR
		Internal : McInternalType;
	END_VAR
...
FUNCTION_BLOCK MC_BR_AsmParam_Acp6D (* Change parameterization of the assembly *)
	VAR_INPUT
		Assembly : REFERENCE TO Mc6DAssemblyType; (* *) (*The assembly reference establishes the connection between the function block and the assembly.*)(*#PAR#;*)
		Enable : BOOL; (*Enable command execution.*) (* *) (*#PAR#*)
		ErrorReset : BOOL; (*Reset error on rising edge*) (* *) (*#PAR#*)
		SegSim : REFERENCE TO McAcp6DAsmSegSimCfgType; (* Segment Simulation *) (* *) (*#CMD#*)
		Ethernet : REFERENCE TO McAcp6DAsmEthernetCfgType; (* Ethernet parameter *) (* *) (*#CMD#*)
		Shuttles : REFERENCE TO McAcp6DAsmShuttlesCfgType; (* Shuttle parameter *) (* *) (*#CMD#*)
		CyclicChannel : REFERENCE TO McAcp6DAsmCyclicChannelCfgType; (* Cyclic Channel parameter *) (* *) (*#CMD#*)
		SystemReactions : REFERENCE TO McAcp6DAsmSystemReactionsCfgType; (* System Reactions parameter *) (* *) (*#CMD#*)
		Layout : REFERENCE TO McAcp6DAsmLayoutCfgType; (* Layout parameter *) (* *) (*#CMD#*)
		Read : BOOL; (*Loads the current parameterization settings into the referenced data structures.*) (*  *) (*#CMD#*)
		Write : BOOL; (*Saves the specified settings at the referenced data structures into the parameterization of the component.*) (* *) (*#CMD#*)
	END_VAR
	VAR_OUTPUT
		Active : BOOL; (*Function block is active and ready to process commands.*) (* *) (*#PAR#*)
		Error : BOOL; (*Execution error*) (* *) (*#PAR#*)
